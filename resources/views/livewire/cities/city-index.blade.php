                   ...
                   <tbody>
                       @forelse ($cities as $city)
                           <tr>
                               ...
                               <td>{{ $city->name }}</td>
                               <td>
                                   <button type="button" class="btn btn-primary" wire:click="showEditModel({{$city->id}})">
                                       Edit
                                     </button>
                                     <button type="button" class="btn btn-success" wire:click="DeleteCity({{$city->id}})">
                                       Delete
                                     </button>
                               </td>
                           </tr>
   ...
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <div class="modal-footer">
        ...
        @if ($editmode)
        <button type="button" class="btn btn-primary" wire:click="editCity({{$city->id}})">update city</button>
    @else
           
    
    <button type="button" class="btn btn-primary" wire:click="createCity()">Add City</button>
